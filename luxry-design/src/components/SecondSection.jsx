  ...
  return (
    <div className='bg-[#FAF3EB]  w-full rounded-t-[24px] h-screen '>
      <h1 className="text-4xl text-[#0B1956]  pt-[50px] px-[50px]  sm:text-5xl lg:text-7xl font-medium leading-[1.5]  playfair">
       <div className='flex  flex-col'><span>Crafted for</span> <span className='md:mx-[3.3em] -mt-0 md:-mt-10'>the few</span></div>
      </h1>
      <div className='flex flex-col  px-5 md:px-0 md:flex-row md:gap-[48px]'>
            <div className=''>
            <img src={frame28} alt="" className='mx-[40px] my-10 w-[322px] h-[408px]'/>
            </div>
            <div>
            <h1 className='md:w-[652px] text-[20px]  tthoves md:pt-10'>For discerning travelers, the world is not a checklist — it’s a canvas. We handpick destinations, curate experiences, and design seamless escapes reserved only for those who demand the extraordinary. From the first call to the final destination, every detail is handled with discretion and care.</h1>
